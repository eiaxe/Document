...
if (isset($_GET['delete'])) {
    ...
    $stmt->close();
    header("Location: organizations.php"); // Redirect back to the list
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add'])) {
    ...
    $columns_result_for_add = $conn->query("SHOW COLUMNS FROM organizations"); // Use a different variable name
    $allowed_fields = [];
    ...
    if (!empty($fields)) {
        $sql = "INSERT INTO organizations (" . implode(",", $fields) . ") VALUES (" . implode(",", $placeholders) . ")";
...
$columns_result_for_display = $conn->query("SHOW COLUMNS FROM organizations"); // Use a different variable name
$column_names = [];
...
<head>
    <meta charset="UTF-8">
    <title>Organizations | Al Hoceima Province</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Organizations list for Al Hoceima Province administration">
    <!-- Google Fonts -->
    ...
    <div class="container">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                         <!-- Link to edit page (assuming it's organizationsedit.php as per original code) -->
                                        <a class="btn" href="organizationsedit.php?id=<?php echo htmlspecialchars($row['id']); ?>">Edit</a>
        ...
        <div class="card">
            ...
            <form method="POST" class="add-form">
                ...
                $columns_result_for_add_form = $conn->query("SHOW COLUMNS FROM organizations");
                ...
                ?>
                 <div class="button-group">
                    <button type="submit" name="add" class="btn">Add Organization</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    function initDarkMode() {
        ...
        // Use a more specific key to avoid conflicts if you have other local storage items
