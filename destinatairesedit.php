...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    ...
    $columns_result = $conn->query("SHOW COLUMNS FROM destinataires");
    $allowed_fields = [];
    if ($columns_result) {
    ...
    if (!empty($set_clauses)) {
        $sql = "UPDATE destinataires SET " . implode(', ', $set_clauses) . " WHERE id = ?";
...
$sql = "SELECT * FROM destinataires WHERE id = ?";
$stmt = $conn->prepare($sql);
...
<head>
    <meta charset="UTF-8">
    <title>Edit Destinataire #<?php echo htmlspecialchars($id); ?> | Al Hoceima Province</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Edit destinataire details for Al Hoceima Province administration">
    <!-- Google Fonts -->
...
<main class="main-content">
    <div class="container">
        <div class="card">
            <h1>Edit Destinataire #<?php echo htmlspecialchars($id); ?></h1>
                ...
                <?php foreach ($row as $key => $value): ?>
                    <?php if ($key != 'id'): ?>
                        <div class="form-group">
                            ...
                            <input type="text" name="<?php echo htmlspecialchars($key); ?>" id="edit_<?php echo htmlspecialchars($key); ?>" value="<?php echo htmlspecialchars($value); ?>" required> <!-- Added 'required' -->
                        </div>
                    <?php endif; ?>
                <?php endforeach; ?>
                <div class="button-group">
                    <button type="submit" class="btn">Save Changes</button>
                    <a href="destinataires.php" class="btn btn-cancel">Cancel</a>
                </div>
            </form>
        </div>
    </div>
