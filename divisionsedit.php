...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    ...
    $columns_result = $conn->query("SHOW COLUMNS FROM divisions");
    $allowed_fields = [];
    if ($columns_result) {
    ...
    if (!empty($set_clauses)) {
        $sql = "UPDATE divisions SET " . implode(', ', $set_clauses) . " WHERE id = ?";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Division #<?php echo htmlspecialchars($id); ?> | Al Hoceima Province</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Edit division details for Al Hoceima Province administration">
    <!-- Google Fonts -->
...
<main class="main-content">
    <div class="container">
        <div class="card">
            <h1>Edit Division #<?php echo htmlspecialchars($id); ?></h1>
            <form method="POST" class="edit-form">
                ...
                <div class="button-group">
                    ...
                    <a href="devision.php" class="btn btn-cancel">Cancel</a>
                </div>
            </form>
        </div>
    </div>
